...
xhr.onreadystatechange = function() {
	...
	function writeToPage() {
		document.getElementById(
			"temp-api"
		).innerHTML = `<a href="#" class="links" title="'Click' for Details">${tempsMax} / ${tempMin} ˚C`;
		document.getElementById("wind-api").innerHTML = `<img id="windsock" 
			...
			alt="windIcon"><a href="#" class="links" title="'Click' for Details"> ${wind}<p class="kph">Kph</p>  ${dir}`;
	}
